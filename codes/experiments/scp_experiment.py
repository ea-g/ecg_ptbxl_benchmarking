...
class SCP_Experiment():
    ...
    def perform(self):
        ...
        for model_description in self.models:
            ...
            elif modeltype == "MINIROCKET":
                # YOUR MODEL GOES HERE!
                from models.your_model import MiniRocketModel
                model = MiniRocketModel(modelname, n_classes, self.sampling_frequency, mpath, self.input_shape, **modelparams)
            else:
                assert(True)
                break
